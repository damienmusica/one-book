...
export const LANGUAGE_LABELS: Record<string, string> = {
  ...
  ur: "우르두어",
  yi: "이디시어",
  // ── 2026-09-04: 지도가 22개 권역을 주장하면서 그 권역의 말을 몰랐다 ──────────
  // 언어 목록은 20세기 서양 코퍼스의 지문이었고, 그 부재가 동남아시아·동유럽·
  // 중앙아시아·아프리카의 뿔을 **데이터 수준에서** 배제했다. 오세아니아 2명,
  // 동남아시아 3명은 세계에 대한 사실이 아니라 이 목록에 대한 사실이었다.
  // 전부 실재하는 ISO 639-1/3 코드다.
  vi: "베트남어",
  id: "인도네시아어",
  th: "태국어",
  tl: "타갈로그어",
...
export const LANGUAGE_LABELS_EN: Record<string, string> = {
  ...
  ur: "Urdu",
  yi: "Yiddish",
  // 2026-09-04 — see the Korean table for why these were missing.
  vi: "Vietnamese",
  id: "Indonesian",
  th: "Thai",
  tl: "Tagalog",
